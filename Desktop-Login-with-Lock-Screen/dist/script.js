...
const Weather = () => {
    const getDays = () => {
        return [{
                ...
                id: 3,
                name: "Wed",
                temperature: N.rand(8, 19),
                weather: WeatherType.Cloudy
            }, {
                id: 4,
                name: "Thurs",
                temperature: N.rand(9, 18),
                weather: WeatherType.Rainy
            }, {
                id: 5,
                name: "Fri",
                temperature: N.rand(4, 16),
                weather: WeatherType.Stormy
            }, {
                id: 6,
                name: "Sat",
                temperature: N.rand(20, 34),
                weather: WeatherType.Sunny
            }, {
                id: 7,
                name: "Sun",
                temperature: N.rand(15, 19),
                weather: WeatherType.Cloudy
            }].map((day) => {
            const getIcon = () => {
                switch (day.weather) {
    ...
    return (React.createElement("div", { id: "app-menu" },
        React.createElement("div", { id: "app-menu-content-wrapper" },
            React.createElement("div", { id: "app-menu-content" },
                ...
                React.createElement("a", { id: "youtube-link", className: "clear-button", href: "https://www.linkedin.com/in/tkamotsepe/", target: "_blank" },
                    React.createElement("i", { className: "fa-brands fa-mail" }),
                    React.createElement("span", null, "Kgosi's LinkedIn Page")),
