...
const WeatherSnap: React.FC = () => {  
  const [temperature] = React.useState<number>(N.rand(19, 32));
...
const Weather: React.FC = () => { 
  const getDays = (): JSX.Element[] => {
    return [{
      ...
      id: 3,
      name: "Wed",
      temperature: N.rand(12, 19),
      weather: WeatherType.Cloudy
    }, {
      id: 4,
      name: "Thurs",
      temperature: N.rand(2, 15),
      weather: WeatherType.Rainy
    }, {
      id: 5,
      name: "Fri",
      temperature: N.rand(3, 14),
      weather: WeatherType.Stormy
    }, {
      id: 6,
      name: "Sat",
      temperature: N.rand(29, 33),
      weather: WeatherType.Sunny
    }, {
      id: 7,
      name: "Sun",
      temperature: N.rand(18, 24),
      weather: WeatherType.Cloudy
    }].map((day: any) => {
      ...
      return (
        <div key={day.id} className="day-card">
          <div className="day-card-content">
            <span className="day-weather-temperature">{day.temperature}<span className="day-weather-temperature-unit">°C</span></span>
    ...
    <div id="app-menu">      
      <div id="app-menu-content-wrapper">
        <div id="app-menu-content">
          ...
          <QuickNav />
          <a id="youtube-link" className="clear-button" href="https://www.linkedin.com/in/tkamotsepe/" />  
            <span>Kgosi Motsepe's Linkedin</span>
          </a>
          <Weather />                  
          <Restaurants />
          <Tools />
